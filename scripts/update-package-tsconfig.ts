...
const TSCONFIG_HEADER =
  '// File generated automatically, use yarn update:tsconfig for update\n'
...
const tsconfigProjectPath = pathJoin(rootPath, ConfigFilename.BUILD_TSCONFIG)
