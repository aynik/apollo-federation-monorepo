...
export type MutationGetTokenArgs = {
  input?: InputMaybe<GetTokenInput>;
};
...
export type JwtResolvers<ContextType = any, ParentType extends ResolversParentTypes['JWT'] = ResolversParentTypes['JWT']> = ResolversObject<{
...
export type ProductResolvers<ContextType = any, ParentType extends ResolversParentTypes['Product'] = ResolversParentTypes['Product']> = ResolversObject<{
  ...
  createdBy?: Resolver<Maybe<ResolversTypes['User']>, { __typename: 'Product' } & GraphQLRecursivePick<ParentType, {"id":true}>, ContextType>;
